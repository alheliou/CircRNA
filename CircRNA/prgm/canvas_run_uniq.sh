...
### 7th step : analyse_stat_circ_file.py 
###python analyse_circ.py $CONCAT > final_filegq333.txt
### 8th step : analyse_finale_fileV2.py
###python analyse_final_file.py final_filegq333.txt f2_gq333.txt f3_gq333.txt f4_gq333.txt tot_filegq333.txt
